...
{
    public class MotoRagdollJointConfig : MonoBehaviour
    {
        ...
        MotoRagdollJointImitation ragdollJointImitation;
        bool onAnimatorIK;

        void Start()
        {
            ragdollJointImitation = FindObjectOfType<MotoRagdollJointImitation>();
            maxForce = 2000f;
